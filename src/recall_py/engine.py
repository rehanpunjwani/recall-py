...
from recall_py.router import draft_confidence, rough_token_count, should_force_escalate
from recall_py.settings import AppSettings
from recall_py.store import repository as repo
from recall_py.text.chunking import chunk_text
from recall_py.text.redact import redact_text
from recall_py.threads import resolve_workspace_thread
    ...
    *,
    ...
    return {
        ...
        "policy": {
            ...
            "escalate": "Call recall_py_escalate_pack for complex multi-step tasks.",
            "ingest": "Call recall_py_ingest_turn(role=assistant) after your reply.",
        },
    ...
    *,
    ...
    if force:
        ...
        return {
            "mode": "escalate",
            "reason": f"policy_keyword:{kw}",
            "escalate_hint": "Call recall_py_escalate_pack with the same thread_id before deep cloud reasoning.",
            "draft": "",
            "citations": [],
    ...
    system = (
        "You are RecallPy's local hint generator. Summarize ONLY from the context blocks. "
